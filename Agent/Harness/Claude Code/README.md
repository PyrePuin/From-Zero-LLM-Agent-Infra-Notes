...
| Phase | 课程 | 主题 | 核心问题 |
|---|---|---|---|
| Phase 1 | s01 - s04 | 基础机制 | 最小骨架长什么样？ |
| Phase 2 | s05, s06, s08 | 上下文治理 | 怎么跑长任务不爆？ |
| Phase 3 | s09 - s11 | 长期记忆与系统提示 | 怎么跨会话连续？ |
| Phase 4 | s12 - s14 | 任务编排 | 怎么跑后台/定时任务？ |
| Phase 5 | s15 - s18 | 多智能体 | 怎么让多个 Agent 协作？ |
| Phase 6 | s07, s19, s20 | 生态与整合 | 怎么接入外部世界？ |
