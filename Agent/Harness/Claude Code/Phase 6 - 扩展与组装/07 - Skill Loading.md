...
flowchart TB
    ...
    style Catalog fill:#d1fae5,stroke:#047857
    style Scan fill:#dbeafe,stroke:#1e40af
    style Load fill:#fde68a,stroke:#b45309
    style SK1 fill:#fef3c7,stroke:#b45309
    style SK2 fill:#fef3c7,stroke:#b45309
    style SK3 fill:#fef3c7,stroke:#b45309
```
