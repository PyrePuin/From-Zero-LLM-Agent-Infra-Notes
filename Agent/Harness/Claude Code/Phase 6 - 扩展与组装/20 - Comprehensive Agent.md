...
flowchart TD
    ...
    Build --> Start
    Esc --> Start
    style Call fill:#fde68a,stroke:#b45309,stroke-width:2px
    style Prep fill:#dbeafe,stroke:#1e40af
    style P1 fill:#dbeafe,stroke:#1e40af
```
...
flowchart LR
    ...
    style Workers fill:#dcfce7,stroke:#166534
```
