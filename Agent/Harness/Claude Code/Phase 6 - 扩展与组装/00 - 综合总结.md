...
flowchart LR
    ...
    K2 -.->|"注入"| A2
    T2 -.->|"组装"| A2
    style K2 fill:#dcfce7,stroke:#166534,stroke-width:2.5px,color:#064e3b
    style T2 fill:#dcfce7,stroke:#166534,stroke-width:2.5px,color:#064e3b
    style A2 fill:#fde68a,stroke:#b45309,stroke-width:2px,color:#451a03
```
...
flowchart TB
    ...
    WT <--> Git
    Skills --> Msgs
    style Msgs fill:#fde68a,stroke:#b45309,stroke-width:2px,color:#451a03
```
