...
flowchart LR
    ...
    style Agent fill:#fde68a,stroke:#b45309
    style Client fill:#dbeafe,stroke:#1e40af
    style Server fill:#d1fae5,stroke:#047857
```
...
flowchart TB
    ...
    style Static fill:#fef3c7,stroke:#b45309
    style Runtime fill:#fef3c7,stroke:#b45309,stroke-width:2px
    style MCP fill:#dbeafe,stroke:#1e40af
    style Loop fill:#fde68a,stroke:#b45309
    style Lead fill:#d1fae5,stroke:#047857
```
