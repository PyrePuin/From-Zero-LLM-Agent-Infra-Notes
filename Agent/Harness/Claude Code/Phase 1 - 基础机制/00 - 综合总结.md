...
flowchart TD
    ...
    s02 -->|"能跑任意工具太危险"| s03
    s03 -->|"循环开始臃肿"| s04
    style s01 fill:#fde68a,stroke:#b45309,stroke-width:3px,color:#451a03
    style s02 fill:#fef3c7,stroke:#b45309,stroke-width:3px,color:#451a03
    style s03 fill:#fde68a,stroke:#b45309,stroke-width:3px,color:#451a03
    style s04 fill:#fef3c7,stroke:#b45309,stroke-width:3px,color:#451a03
```
...
flowchart TD
    ...
    style PreHook fill:#dbeafe,stroke:#1e40af,stroke-width:2.5px,color:#1e3a8a
    style Dispatch fill:#fde68a,stroke:#b45309,stroke-width:3px,color:#451a03
    style PostHook fill:#dbeafe,stroke:#1e40af,stroke-width:2.5px,color:#1e3a8a
    style Deny fill:#fecaca,stroke:#991b1b,stroke-width:2.5px,color:#7f1d1d
```
