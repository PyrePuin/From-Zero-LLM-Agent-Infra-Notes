...
flowchart TD
    ...
    style H1 fill:#dbeafe,stroke:#1e40af,stroke-width:2.5px,color:#1e3a8a
    style H2 fill:#fde68a,stroke:#b45309,stroke-width:3px,color:#451a03
    style H3 fill:#dbeafe,stroke:#1e40af,stroke-width:2.5px,color:#1e3a8a
    style H4 fill:#fde68a,stroke:#b45309,stroke-width:3px,color:#451a03
```
