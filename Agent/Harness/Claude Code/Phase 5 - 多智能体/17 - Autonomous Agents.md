...
flowchart TB
    ...
    style Board fill:#fef3c7,stroke:#b45309,stroke-width:2px,color:#451a03
    style Workers fill:#dbeafe,stroke:#1e40af,stroke-width:2.5px,color:#1e3a8a
...
flowchart TB
    ...
    style TaskBoard fill:#fef3c7,stroke:#b45309,stroke-width:3px,color:#451a03
    style Scan fill:#dbeafe,stroke:#1e40af,stroke-width:2px,color:#1e3a8a
    style Lead fill:#fde68a,stroke:#b45309,stroke-width:3px,color:#451a03
...
flowchart TB
    ...
    style SharedDisk fill:#fef3c7,stroke:#b45309,stroke-width:2px,color:#451a03
```
